#Fraction Remaining graphs for homes
...
#plots
plot(fre, type='l', col=3, xlab="Years",ylab="Fraction Remaining of Original Product",main="Fraction remaining in each year for products with 100 year halflives")
