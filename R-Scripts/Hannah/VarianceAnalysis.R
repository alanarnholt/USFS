...
for(i in 1:2000){
  ...
  halflivesmatters[,1]<- halflivesmatters[,1]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,2]<- halflivesmatters[,2]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,3]<- halflivesmatters[,3]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,4]<- halflivesmatters[,4]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,5]<- halflivesmatters[,5]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,6]<- halflivesmatters[,6]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,7]<- halflivesmatters[,7]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,8]<- halflivesmatters[,8]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,9]<- halflivesmatters[,9]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,10]<- halflivesmatters[,10]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,11]<- halflivesmatters[,11]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,12]<- halflivesmatters[,12]*(randomError + 1)
...
for(i in 1:2000){
  halflivesmatters <- halfLives
  randomError<-rnorm(length(halflivesmatters[,1]),1,.2)
  halflivesmatters[,13]<- halflivesmatters[,13]*(randomError + 1)
