...
\item These sources include solid wood and paper production and time series, factor to convert solid wood and paper products to carbon, fractions of solid wood and paper products subject to decay in landfills, and decay rate for solid wood and paper in SWDS.
...
\end{figure}
{\bf Figure 1.} Projections based on 5-year (orange) and 10-year (blue) simple linear regression
\end{center}
\end{block}
...
\end{figure}
{\bf Figure 2.} Reported HWP and SWDS carbon stock produced by WOODCARB3 (red) surrounded by simulations including reported uncertainties (blue)
\end{center}
\end{alertblock} 
...
\end{figure}
{\bf Figure 3.} Decay of a product with 50-year half-life using exponential (red), $k=2$ (blue), and $k=10$ (green) functions
\end{center}
...
\end{figure}
{\bf Figure 5.} Sensitivity of total HWP stock to changes in half-life
\end{center}
\end{block}
...
\end{figure}
{\bf Figure 5.} Targeted increase in half-life of paper (orange) by 50-percent (blue)
\end{center}
\end{block}
