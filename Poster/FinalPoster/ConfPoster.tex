...
{\ttfamily\noindent\bfseries\color{errorcolor}{Error in library(PASWR): there is no package called 'PASWR'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in library(tree): there is no package called 'tree'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{Error in library(randomForest): there is no package called 'randomForest'}}
